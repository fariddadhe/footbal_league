...
object FakeData {
    ...
    fun getMatch(): MutableList<EventEntity> {
        val match: MutableList<EventEntity> = mutableListOf()
        ...
        match.add(
            EventEntity(
                ...
                "English Premier League 2019-12-03 Sheffield United vs Newcastle",
                "Soccer",
                4328,
    ...
    fun getDetailMatch(): MutableList<EventEntity> {
        val match: MutableList<EventEntity> = mutableListOf()
    ...
    fun getDetailLeague(): MutableList<LeaguesDetail> {
        val league: MutableList<LeaguesDetail> = mutableListOf()
    ...
    fun getSearchMatch(): MutableList<EventEntity> {

        val search: MutableList<EventEntity> = mutableListOf()
        ...
        search.add(
            EventEntity(
                ...
                "Ein Frankfurt @ Arsenal",
                "UEFA Europa League 2019-11-28 Arsenal vs Ein Frankfurt",
                "Soccer",
                4481,
                "UEFA Europa League",
                1920,
    ...
    fun getDetailTeams(): MutableList<TeamsEntity> {
